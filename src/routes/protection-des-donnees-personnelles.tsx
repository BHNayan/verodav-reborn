  ...
  return (
    ...
    >
      <Section title="Préambule">
        <p>La Société accorde une grande valeur à l'honnêteté et a à cœur de construire avec ses clients une relation forte fondée sur la confiance et l'intérêt mutuel. Conformément à cette philosophie, la protection des données personnelles de ses clients est essentielle à ses yeux. La Société souhaite donc les informer, par l'intermédiaire de cette politique de confidentialité, de la manière dont elle collecte et traite ces données.</p>
      ...
      <Section title="Collecte des données personnelles">
        <p>Par donnée à caractère personnel, l'on entend « toute information se rapportant à une personne physique identifiée ou identifiable », au sens de l'article 4, 1) du RGPD.</p>
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li><strong>Données de connexion, géolocalisation et navigation</strong> : adresse IP, identifiants de connexion, type de navigateur, demandes serveur et horaires, URL référent, cookies, traceurs, données de navigation, mesures d'audience, terminaux de connexion…</li>
        ...
        <p>Conformément au RGPD, la Société ne collecte ni ne traite de données dites « sensibles » (origine raciale ou ethnique, opinions politiques, convictions religieuses ou philosophiques, appartenance syndicale, données génétiques et biométriques, santé, vie sexuelle, condamnations pénales, ni numéro de sécurité sociale).</p>
      </Section>
      ...
      <Section title="Finalités du traitement des données personnelles">
        ...
        <p><strong>Gestion administrative et financière.</strong> En raison d'un intérêt légitime, la Société peut être tenue de communiquer certaines données du Client en cas de demandes légitimes d'autorités publiques (sécurité nationale, lutte contre la fraude, application de la loi).</p>
      ...
      <Section title="Durée de conservation des données">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-t border-border"><td className="p-3">Données du compte Client</td><td className="p-3">5 ans à compter de la fin de la relation commerciale (dernière connexion, dernier appel ou courriel au service client).</td></tr>
              ...
              <tr className="border-t border-border"><td className="p-3">Données relatives aux actions commerciales</td><td className="p-3">3 ans à compter du dernier contact ou de la fin de la relation.</td></tr>
      ...
      <Section title="Destinataires des données">
        ...
        <p>La Société peut également fournir des données personnelles aux autorités de contrôle (administration fiscale et douanière, police et autres organes statutaires) lorsque la loi l'exige.</p>
        <p>Ces données sont hébergées et stockées sur des serveurs localisés dans des États membres de l'Union européenne, et ne font l'objet d'aucun transfert hors Union européenne.</p>
      </Section>

      <Section title="Mesures de sécurité et de confidentialité">
        <p>La Société s'engage à ne pas vendre, louer ni partager les informations personnellement identifiables des utilisateurs avec des tiers, sauf raison légale contraignante (transmission aux autorités de surveillance ou de poursuite pénale).</p>
        <p>En application de l'article 32 du RGPD, des mesures de sécurité techniques et organisationnelles ont été instaurées afin de protéger les données contre toute intrusion malveillante, perte, destruction, altération ou accès par des personnes non autorisées :</p>
        <ul className="list-disc pl-6 space-y-1.5">
        ...
        <p>La Société invite également les Clients à faire preuve de prudence pour empêcher tout accès non autorisé à leurs données, en protégeant leurs terminaux par un mot de passe fort et en le changeant régulièrement.</p>
      </Section>
      ...
      <Section title="Droits des utilisateurs">
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li><strong>Droit d'opposition</strong> — s'opposer à tout moment au traitement, pour des raisons tenant à sa situation particulière.</li>
        ...
        <p>La Société n'a recours à aucun processus de traitement entièrement automatisé pour prendre une décision et aucun profilage n'est réalisé sur la base des données collectées. Le consentement donné par un utilisateur peut être retiré à tout moment.</p>
      </Section>

      <Section title="Exercice des droits — Contact">
        <p>Tout Client peut obtenir des informations ou exercer ses droits auprès du Responsable de traitement :</p>
        <p>
        ...
        <p>La Société s'engage à répondre à toute demande dans un délai raisonnable qui ne saurait dépasser un (1) mois à compter de la réception.</p>
