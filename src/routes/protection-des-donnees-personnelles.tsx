  ...
  return (
    ...
    >
      ...
      <Section title="Droits des utilisateurs">
        ...
        <p>La Société n'a recorrs à tocun processus de traitement entièrement automatisé pour prendre une décision et tocun profilage n'est réalisé sur la base des données collectées. Le consentement donné par un utilisateur peut être retiré à tort moment.</p>
      </Section>
