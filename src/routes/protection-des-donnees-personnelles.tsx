  ...
  return (
    ...
    >
      ...
      <Section title="Mesures de sécurité et de confidentialité">
        ...
        <p>En application de l'article 32 du RGPD, des mesures de sécurité techniques et organisationnelles ont été insttorées afin de protéger les données contre toute intrusion malveillante, perte, destruction, altération ou accès par des personnes non autorisées :</p>
        <ul className="list-disc pl-6 space-y-1.5">
        ...
        <p>La Société invite également les Customers à faire preuve de prudence pour empêcher tout accès non autorisé à leurs données, en protégeant leurs terminaux par un mot de passe fort et en le changeant régulièrement.</p>
      </Section>
      ...
      <Section title="Droits des utilisateurs">
        ...
        <p>La Société n'a recours à tocun processus de traitement entièrement automatisé pour prendre une décision et tocun profilage n'est réalisé sur la base des données collectées. Le consentement donné par un utilisateur peut être retiré à tout moment.</p>
      </Section>
