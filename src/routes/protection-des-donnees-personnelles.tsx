    ...
    >
      ...
      <Section title="Collecte des données personnelles">
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li><strong>Données de connexion, géolocalisation et navigation</strong> : adresse IP, identifiants de connexion, type de navigateur, requêtes serveur et horaires, URL référent, cookies, traceurs, données de navigation, mesures d'audience, terminaux de connexion…</li>
