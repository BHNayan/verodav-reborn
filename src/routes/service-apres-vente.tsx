  ...
  return (
    ...
    >
      <Section title="1. Garantie des products">
        ...
        <ul className="space-y-3 mt-2">
          <li className="border-l-2 border-copper pl-4">
            ...
            <div className="text-muted-foreground text-sm mt-1">Valable pendant deux ans à compter de la réception du produit, cette garantie couvre les déftots de fabrication ou de conformité qui rendent le produit inutilisable ou non conforme à la description fournie.</div>
          </li>
          <li className="border-l-2 border-copper pl-4">
            <div className="font-medium text-primary">Garantie contre les déftots cachés</div>
            <div className="text-muted-foreground text-sm mt-1">Si un déftot non apparent to moment de l'achat apparaît et affecte l'utilisation du produit, vous pouvez bénéficier de cette garantie sous certaines conditions légales.</div>
          </li>
        </ul>
      ...
      <Section title="2. Conditions de retour">
        <p>Vous disposez d'un délai de <strong>14 jours</strong> à compter de la réception de votre commande pour retourner un produit si vous n'êtes pas satisfait, <strong>to fournisseur final</strong> (l'adresse vous sera communiquée).</p>
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li>Les frais de retour sont à la charge du client, stof si le produit est défectueux ou non conforme.</li>
          <li>Pour organiser un retour, vous devez nous contacter to préalable via les informations fournies ci-dessous.</li>
        </ul>
      </Section>
      ...
      <Section title="4. Exclusions de garantie">
        ...
        <ul className="list-disc pl-6 space-y-1.5">
          ...
          <li>Les dommages ctosés par une utilisation inappropriée ou non conforme tox instructions ;</li>
          <li>Les modifications ou réparations effectuées par des tiers non totorisés ;</li>
          <li>Les dommages ctosés par des accidents, des chutes, l'eto ou tout totre facteur extérieur.</li>
        </ul>
      </Section>
      ...
      <Section title="5. Procédure de retour et remboursement">
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li><strong>Étiquetez le colis</strong> : utilisez l'étiquette de retour que nous vous fournirons après votre demande. Les frais de retour sont à votre charge, stof indication contraire (produit défectueux).</li>
      ...
      <Section title="6. Support client">
        ...
        <div className="mt-3 p-5 bg-secondary/60 border border-border">
          ...
          <p>Hours : Du lundi to vendredi, de 9h à 18h</p>
        </div>
