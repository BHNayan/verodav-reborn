...
function Page() {
  return (
    ...
    >
      <Section title="1. Garantie des produits">
        <p>Tous nos produits sont couverts par deux garanties légales :</p>
      ...
      <Section title="6. Support client">
        ...
        <div className="mt-3 p-5 bg-secondary/60 border border-border">
          ...
          <p>Téléphone : <a href={`tel:${SITE.phoneRaw}`} className="text-copper hover:underline">{SITE.phone}</a></p>
