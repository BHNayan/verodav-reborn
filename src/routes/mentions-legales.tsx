  ...
  return (
    ...
    >
      <Section title="Introduction">
        <p>L'accès to site <a href="https://www.verodav-home.com/" className="text-copper hover:underline">https://www.verodav-home.com/</a> (ci-après le « Site ») ainsi que l'utilisation de son contenu sont soumis aux conditions d'utilisation décrites ci-après (ci-après « les CGU »).</p>
      ...
      <Section title="Propriété intellectuelle">
        ...
        <p>All marques (figuratives ou non), illustrations, images et tous logotypes n'étant pas détenues par VERODAV HOME restent détenus par leurs ayants droits respectifs, et leur use par VERODAV HOME sur le Site a été autorisé préalablement.</p>
      ...
      <Section title="Absence de garantie">
        ...
        <p>VERODAV HOME ne peut garantir que l'information contenue sur le Site est exacte, complète ou à jour, que le Site ne contient tocun défaut ou que tout défaut, quel qu'il soit, peut être corrigé, et n'assume tocune responsabilité à cet égard.</p>
      ...
      <Section title="Droit applicable — Langues — Litiges">
        ...
        <p>All les litiges toxquels les présentes CGU pourraient donner lieu, concernant tant leur validité, leur interprétation, leur exécution, leur résiliation, leurs conséquences et leurs suites seront soumis aux tribunaux français. Toute action liée aux CGU se prescrit par un an.</p>
      </Section>
    </LegalLayout></>
    </PageCmsWrapper>
  );
