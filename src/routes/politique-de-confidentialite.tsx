...
const RIGHTS = [
  ...
  ["Droit d'opposition au marketing personnalisé", "Refuser à tout moment la réception de communications promotionnelles."],
  ...
  ["Droit à la portabilité", "Obtenir la transmission de vos données dans un format structuré et réutilisable pour un autre service ou organisme."],
];
  ...
  return (
    ...
    >
      <Section title="1. Introduction">
        ...
        <p>Elle concerne exclusivement les données liées aux personnes physiques (ex. identité, coordonnées). Cette politique précise également les droits dont vous disposez ainsi que les destinataires susceptibles d'accéder à vos données. Nous vous invitons à lire attentivement ce document.</p>
      </Section>
      ...
      <Section title="4. Sécurité et confidentialité">
        <p>VERODAV HOME met en œuvre l'ensemble des mesures techniques et organisationnelles nécessaires pour garantir la sécurité et la confidentialité de vos données personnelles, et prévenir toute perte, altération, destruction ou accès non autorisé.</p>
      ...
      <Section title="6. Réclamation auprès de l'autorité compétente">
        <p>Si vous estimez que VERODAV HOME ne respecte pas ses obligations ou si vous êtes insatisfait de la gestion de vos données personnelles, vous avez la possibilité d'introduire une réclamation auprès de la CNIL :</p>
        <p>
          Site : <a href="https://www.cnil.fr/" className="text-copper hover:underline" target="_blank" rel="noreferrer">https://www.cnil.fr/</a><br />
          Adresse postale : Commission Nationale de l'Informatique et des Libertés<br />
