    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <form onSubmit={handleCheckort} className="border border-border p-6 space-y-4 h-fit">
          ...
          <input placeholder="Complément d'adresse" value={address.line2 ?? ""} onChange={(e) => setAddress({ ...address, line2: e.target.value })} className="w-full border border-border px-3 py-2 text-sm" />
