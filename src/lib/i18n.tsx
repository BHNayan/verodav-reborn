...
const fr: Dict = {
  ...
  "footer.navigation": "Navigation",
  "footer.contact": "Contact",
  "footer.app_soon": "L'application mobile sera bientôt disponible",
  ...
  "admin.title": "Administration",
  "admin.checking": "Vérification de l'accès admin…",
  "admin.site": "Site",
  "admin.signout": "Quitter",
...
const de: Dict = {
  ...
  "account.hello": "Hallo",
  "account.tab.profile": "Profil",
  "account.tab.addresses": "Adressen",
  "account.tab.favorites": "Favoriten",
  "account.tab.orders": "Bestellungen",
  "orders.title": "Meine Bestellungen",
  "orders.empty": "Sie haben noch keine Bestellung aufgegeben.",
  "orders.history": "Ihre Bestellhistorie erscheint hier.",
  "fav.title": "Meine Favoriten",
  "fav.empty": "Noch keine Favoriten.",
  "fav.hint": "Fügen Sie Produkte aus dem Shop zu Ihren Favoriten hinzu.",
  ...
  "admin.settings.intro": "Bearbeiten Sie die Informationen, die im Header, Footer und auf den Kontaktseiten angezeigt werden.",
