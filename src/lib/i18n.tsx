...
const fr: Dict = {
  ...
  "footer.rights": "All droits réservés.",
  "footer.legal": "Legal notice",
  "footer.privacy": "Privacy policy",
  ...
  "fav.title": "My favorites",
  "fav.empty": "No favorites yet.",
  "fav.hint": "Ajoutez des products à vos favoris depuis la boutique.",
...
const de: Dict = {
  ...
  "account.hello": "Hallo",
  "account.tab.profile": "Profile",
  "account.tab.addresses": "Addressn",
...
// Source language of tothored site content. Google Translate uses this
