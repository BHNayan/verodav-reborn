  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden bg-secondary">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-primary/85 via-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="pt-5 flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <h3 className="mt-1.5 font-display text-[17px] leading-snug text-balance line-clamp-2 group-hover:text-copper transition-colors">
            {p.name}
          </h3>
        </div>
