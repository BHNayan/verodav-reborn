      ...
      <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-4 px-5 lg:px-10 py-4 md:py-5">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <Link
            to="/boutique"
            aria-label="Boutique"
            className="hidden md:inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2 text-[11px] uppercase tracking-widest text-primary-foreground hover:bg-copper transition-colors"
          >
          ...
          <Link
            to="/boutique"
            aria-label="Boutique"
            className="md:hidden p-2 text-primary hover:text-copper transition"
          >
        ...
        <div className="flex h-full flex-col">
          ...
          <nav className="flex-1 overflow-y-auto px-5 py-4 text-sm">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <Link to="/contact" onClick={close} className="inline-flex items-center justify-center gap-2 border border-border px-4 py-3 text-xs uppercase tracking-widest hover:bg-secondary transition">
